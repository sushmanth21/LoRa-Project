...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
 ...
 h1 { font-family: Arial; color: #800080; display: inline-block; margin: 0px auto; text-align: center; font-size: 1.5rem; }
 h2 {font-family: calibri; color: #006400; display: inline-block; margin: 0px auto; text-align: center; font-size: 1.5rem;}
 h3 { font-family: Times New Roman; color: #800080; display: inline-block; margin: 0px auto; text-align: center; font-size: 1.5rem; }
 h4 { font-family: Times New Roman; color: black; display: inline-block; margin: 0px auto; text-align: left ; font-size: 1.0rem; }
 h5{ font-family: Times New Roman; color: #800080; display: inline-block; margin: 0px auto; text-align: center; font-size: 1.1rem; }

 p1 {font-size: 1.5rem; color: darkgreen; font-family: Times New Roman;} 
    .units{font-size: 1.5rem; vertical-align:top;}
    .percentlabels{font-size: 1.5rem; vertical-align:top;}
      
 p2 {font-size: 1.5rem; color: darkgreen; font-family: Times New Roman;}   
 p3 {font-size: 1.5rem; color: darkgreen; font-family: Times New Roman;}   
 p4 {font-size: 1.5rem; color: darkgreen; font-family: Times New Roman;}   
 
</style>
</head>
<body>
<img src="http://sietk.org/images/sietk-logo.png" width="130" height="130" text-align= right;>
<img src="http://sietk.org/images/header-image-clgname.png " width="480" height="120" text-align= center;>
<img src="http://sietk.org/images/header-image-naac-aicte.png " width="325"  height="120" text-align= left;>
<br>
...
<b>
    ...
    <span class="percentlabels">Trash Bin : </span> 
...
<h5><b> UNDER THE ESTEEMED GUIDANCE OF:  </b></h5>
<br>
<br>
...
<div style="background: #FFF0F5; 
            float:right;
            padding-top: 10px; padding-right: 13px; padding-left: 20px; padding-bottom: 10px;
            border: 5px solid purple; 
            margin: 35px;">

<h5><b> &nbsp PROJECT MEMBERS:  &nbsp</b></h5>
<br>
<br>
  ...
  {  
    ...
    if(rf95.recv(buf, &len))
    {
     ...
     if ((percent>50) && (percent<=90)){
      ...
      bot.sendMessage(CHAT_ID, "Hi! TrashBin is filled up, Please segregate it fast!!! ","");
      delay(500);
     }
